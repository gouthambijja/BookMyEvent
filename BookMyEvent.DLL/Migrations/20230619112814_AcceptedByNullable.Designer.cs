...
namespace BookMyEvent.DLL.Migrations
{
    ...
    [Migration("20230619112814_AcceptedByNullable")]
    partial class AcceptedByNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("db.Models.Administration", b =>
                {
                    ...
                    b.HasIndex(new[] { "GoogleId" }, "Unique_Administration_Google_Id")
                        .IsUnique()
            ...
            modelBuilder.Entity("db.Models.Event", b =>
                {
                    ...
                    b.Property<int>("AvailableSeats")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("([Capacity])", false);
